...
class Talk:
  ...
  UA = "Line/7.18.0"#"Mozilla/5.0"
  LA = "CHROMEOS\t1.4.17\tChrome_OS\t1"#"CHROMEOS\x091.4.13\x09Chrome_OS\x091"
  #UA = "Line/7.18.0"#"Mozilla/5.0"
  #LA = "CHROMEOS\t.1.4.5\tChrome_HP\t1"#"CHROMEOS\x091.4.13\x09Chrome_OS\x091"
  ...
  def qrLogin(self, callback):
    ...
    qr = self.client.getAuthQrcode(True, "TGB-PC")
    callback("Geura login weh ieu linkna cuma 2 menit soalna >:(\nCreated By TeamGreatBot \nline://au/q/" + qr.verifier)
